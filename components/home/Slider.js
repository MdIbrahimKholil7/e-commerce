...
import heroImg1 from '../assets/Ellipse 622 (1).png'
import heroImg2 from '../assets/Ellipse 622.png'
...
const HeroSlider = () => {
    ...
    return (
        <div>
            <div className="hero min-h-screen p-0 my-20 lg:my-10">
                <div className="hero-content justify-between flex-col lg:flex-row-reverse items-center max-w-[2100px] p-0">
                    ...
                    <div className='w-full my-20 lg:my-0'>
                        ...
                        <div className='pl-5 md:pl-14'>
                            <h1 className="text-[27px] md:text-[34px] lg:text-[44px] xl:text-[53px] 2xl:text-[64px] text-[#112D57] font-bold">Buy Product Online</h1>
